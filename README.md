...
Connect the RS485 to USB cable to laptop
...
Set Export / Import limits and Aux outputs

Write changes

Test outputs if necessary
...
If a Channel fault is shown or both aux outputs are off, press reset.

The G100 will not connect if the Cerbo is in demo mode.
